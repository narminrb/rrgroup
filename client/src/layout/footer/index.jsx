...
import LogoFooter from '../../../public/assets/footer.svg'
import './style.css'
const Footer = () => {
  return (
    <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
      <div className="space-y-4">
        <div className="flex items-center">
          <a href="/rrgroup" className="flex items-center">
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-3">
          <li><a href="/rrgroup/about" className="text-white hover:text-white transition">Haqqımızda</a></li>
          <li><a href="/rrgroup/career" className="text-white hover:text-white transition">Karyera</a></li>
          <li><a href="/rrgroup/ksm" className="text-white hover:text-white transition">KSM</a></li>
        </ul>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-3">
          <li><a href="/rrgroup/services" className="text-white hover:text-white transition">Xidmətlər</a></li>
          <li><a href="/rrgroup/projects" className="text-white hover:text-white transition">Layihələr</a></li>
        </ul>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-3">
          <li><a href="/rrgroup/contact" className="text-white hover:text-white transition">Əlaqə</a></li>
          <li><a href="/rrgroup/news" className="text-white hover:text-white transition">Xəbərlər</a></li>
        </ul>
      </div>
    </div>
