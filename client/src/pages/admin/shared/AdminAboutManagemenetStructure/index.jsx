...
import { getAboutManagementStructure, updateAboutManagementStructure } from "@/http/managementstructure";

const AdminAboutManagementStructure = () => {
  const [paragraph, setparagraph] = useState("");
  const [modalOpen, setModalOpen] = useState(false);

  useEffect(() => {
    getAboutManagementStructure()
      .then((res) => {
        const item = res.data;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateAboutManagementStructure(body);
    ...
    <div className="p-8 mx-auto">
      ...
      <div className={clsx(styles.card)}>
        <table className="w-full table-auto border-collapse">
          <tbody>
            <tr>
              <td className={clsx(styles.cardname)}>İdarəetmə strukturu</td>
            </tr>
            <tr>
...
export default AdminAboutManagementStructure;
